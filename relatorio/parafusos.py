...
FIXADORES = [
    ...
    ("3", "Parafuso M3 × 25 mm, cabeça panela Phillips ou cilíndrica Allen (rosca total)",
     ...
     "Ø3,4 na palma e no dedo livre. Empilhamento: palma 4 + ressalto/engrenagem 14,8 + 2 arruelas 1,0 + porca autotravante 4,0 ≈ 24 mm",
     "Aço inox A2 (superfície lisa = menos atrito na engrenagem)", 2),
    ("3b", "Parafuso M3 × 10 mm, cabeça panela Phillips (rosqueia direto no PLA)",
     "4", "6",
     "Amarram as duas chapas de cada elo: 2 na travessa do braço (04_braco_livre → 03_braco_motriz) e 2 na palma do antebraço (06_antebraco_livre → 05_antebraco_motriz). São eles que fecham a forquilha — sem eles as chapas abrem",
     "Passante Ø3,4 na chapa motriz + furo-piloto Ø2,5 × 8 mm no reforço da travessa/palma. Empilhamento: chapa 4 + 6 mm de rosca no PLA",
     "Aço zincado ou inox A2", 2),
    ...
    ("6", "Parafuso M3 × 12 mm, cabeça panela Phillips",
     ...
     "Rasgos RADIAIS 3,4 × 11,4 no suporte (aceitam furação de 21,5 a 34,5 mm × 15,4 a 24,6 mm) + furos Ø3 da placa. Empilhamento: placa 1,6 + assento do berço 3 + chapa 4 + arruela 0,5 + porca 2,4 = 11,5 mm",
    ...
    ("8", "Arruela lisa M3 ampla (Ø3,2 × Ø9 × 0,8 mm) — se não houver, a comum Ø7 serve",
     "8", "10",
     "Sob a cabeça dos parafusos dos joysticks: cobre o rasgo radial de 3,4 × 11,4 mm",
     "—", "Aço zincado", 2),
...
NOTAS = [
    ...
    "Os pivôs do lado LIVRE (ombro e cotovelo) não levam parafuso: são munhões Ø9 impressos na própria chapa, que giram "
    "nos mancais Ø9,4 da parede da plataforma e da chapa livre do braço. Quem segura o conjunto no eixo é o parafuso central "
    "do horn do lado motriz (item 1b) somado às travessas (item 3b) — por isso os 4 parafusos M3 × 10 são obrigatórios.",
