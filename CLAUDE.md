...
- [x] 2026-09-21: repositório GitHub `RoberliSchuina/braco-robotico-4gdl` — público desde 2026-09-22 (remote `origin`, branch `main`); `gh` instalado em `C:\Program Files\GitHub CLI\` e autenticado. Após alterar/regenerar: `git add -A && git commit && git push`
